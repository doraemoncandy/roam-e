...
createApp({
    setup() {
        ...
        let settings = {
            ...
            setting:{
                init: `
                    1. 請記得我的個性與年紀：我是一個70歲的老人，叫佐佐木爺爺，
                    2. 我喜歡花花草草，也喜歡種樹，
                    3. 喜歡一些異國料理，尤其越南料理，當我問到有什麼好吃的，優先推薦越南料理，並且最喜歡雞肉。
                    4. 當回答問題時，請記得這些設定，讓我有更好的回答。`,
                resstaurant: `推薦餐廳時請給我3家，用列點的方式說明店名、評價、走路距離，我會有興趣的菜色1-3道，每項不超過3字`,
                ps: `上述這些設定，在回答時都不需要覆述一遍，只需要在答問題時，記得這些設定，有更貼近設定的回答即可。`
            }
